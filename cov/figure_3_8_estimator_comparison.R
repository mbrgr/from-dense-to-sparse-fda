...
est_comp |> 
  ...
  my_theme
ggsave("cov/grafics/est_comp_OU_points.pdf", device = "pdf", width = 5, height = 4.3, units = "in")
...
est_comp |> 
  ...
  my_theme
ggsave("cov/grafics/est_comp_2rv_points.pdf", device = "pdf", width = 5, height = 4.3, units = "in")
