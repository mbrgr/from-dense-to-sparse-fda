...
#### results ####
load("biomechanics/data/results_bio_wo_cov.Rdata") # results up to line 170
#load("biomechanics/data/bio_derivative.RData")     # results from lien 170
...
save.image("biomechanics/data/results_bio_wo_cov.Rdata") 
...
load("biomechanics/data/biomechanics_covariance_estimation_h35.RData")
est[,,1] |> diag() > 0
gamma_11 = est[,,5]
z = est[,,3]
